...
int main()
{
    ...
    if (a >= 'A' && a <= 'Z')
    {
        printf(" THE Enterred chracter is in upercase");
    }
...
int main()
{
    ...
    if (a % 7 == 0 || a % 2 == 0)
    {
        printf(" The given no. is divisible by 7 or  2");
    }
    else
    {
        printf(" The given no. is not divisible by 7 or  2");
    }
